<script lang="ts">
	/**
	 * Dashboard page for SSR client-nav test (issue #21 reproduction)
...
<div class="mx-auto max-w-2xl p-8">
	<h1 class="mb-6 text-2xl font-bold">Client Nav SSR - Dashboard (Issue #21)</h1>
	<p class="mb-6 text-gray-600">
		Target page after client-side navigation from login (SSR layout).
	</p>
	...
	<div class="space-y-4">
		...
		{:else}
			<div class="rounded bg-red-100 p-4" data-testid="unauthenticated-state">
				...
				<a
					href="/test/client-nav-ssr/login"
